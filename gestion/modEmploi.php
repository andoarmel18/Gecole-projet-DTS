                    ...
                    <?php while($heures = $heure->fetch()) : $idHeure = $heures['idHeure'] ?> 
                        <tr> 
                            ...
                            $modEdt = $databases->getAllData('SELECT * FROM profmat pm
                                ...
                                JOIN semestriel s ON m.semestre=s.idSemestre
                            ...
                            <?php if($modEdt) :?>
                                <option style="color:blue" value=<?=$modEdt['idProfMat']?>><?=$modEdt['nomMatiere'].' ('.$modEdt['nomProf'].' '.$modEdt['prenomProf'].') ('.$modEdt['nomSemestre'].')'?></option>
                            <?php else : ?>
                                <option value=""></option>
                            <?php endif?> 
                            <?php
                            $profMat = $databases->requette('SELECT * FROM profmat pm
                                ...
                                <option value=<?=$pm['idProfMat']?>><?=$pm['nomMatiere'].' ('.$pm['nomProf'].' '.$pm['prenomProf'].') ('.$pm['nomSemestre'].')'?></option>
                                <?php endwhile ?>
